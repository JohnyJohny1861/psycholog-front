...
import bg_1 from '../../../assets/3.jpg';
import bg_2 from '../../../assets/2.jpg';
import bg_3 from '../../../assets/1.jpg';
...
export default () => {
    ...
    const [leftStyle, setLeftStyle] = useState(window.innerWidth < 786 ? true : false);
    ...
    return (
        <div className="Header">
            <div className="row h-100">
                <div 
                    className="col-md-7 col-sm-12  Header_left" 
                    ref={leftRef}
                    style={{
                    ...
                    <div className="Header_info-wrapper" ref={infoRef}>
                        ...
                        <a className="info_iterator custom-btn" ref={info_iteratorRef} href="/">
                            <span className="info_iterator-text">Qisqacha ma'lumot</span>
                ...
                <div 
                    className="col-md-5 d-none d-md-block Header_right" 
                    ref={rightRef}
