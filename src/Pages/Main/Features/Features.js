    ...
    return (
        <div className="features container">
            <div className="feature">
                <img className="feature__icon" src={feature_1} alt="icon" />
            ...
            <div className="feature">
                <img className="feature__icon" src={feature_2} alt="icon"/>
            ...
            <div className="feature">
                <img className="feature__icon" src={feature_3} alt="icon"/>
            ...
            <div className="feature">
                <img className="feature__icon" src={feature_4} alt="icon"/>
            ...
            <div className="feature">
                <img className="feature__icon" src={feature_5} alt="icon"/>
            ...
            <div className="feature">
                <img className="feature__icon" src={feature_6} alt="icon"/>
